...
items89 = query_L89_items(datetime=datetime89, bbox=bbox, max_cloud=max_cloud, landsats=["landsat-8", "landsat-9"])

items457 = query_L457_items(
    datetime=datetime457, bbox=bbox, max_cloud=max_cloud, landsats=["landsat-4", "landsat-5", "landsat-7"]
)
...
# %%
extract_fz_timeseries(da, data, field, "TID", path_csv, name, "allLandsat", "lst", ochunk=64, verbose=False)
# %%
